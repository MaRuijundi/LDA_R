...
library(topicmodels)
#设置工作目录（根据需要修改路径）
setwd("C:\\Myproject_LDA\\database5\\data21_2486") 
#加载文档到语料库
#获取目录中的.txt文件列表
...
# 删除通用和自定义的停用词
stopword <- c(stopwords('english'),"dietary","adher","patient","ill","disea","bread","cook","india","cancer","studi","use","ti","ab","can","one","and","like","just","gonna","know","really","right","going","get","well","lot","actually","new",
...
ldaOut.terms <- as.matrix(terms(ldaOut,1900))
